                            ...
                            {canManage && projects.length > 0 && (
                                <>
                                    ...
                                    <button
                                        ...
                                        title={localize(
                                            'Rule-based OKR suggestions (no cloud LLM by default). Enable VITE_ENABLE_EXTERNAL_TEXT_AI only if you configure API keys.',
                                            'Suggestions OKR par règles locales (sans LLM cloud par défaut). Activez VITE_ENABLE_EXTERNAL_TEXT_AI seulement si les clés API sont configurées.',
                                        )}
                                    >
