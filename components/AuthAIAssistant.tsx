...
const AuthAIAssistant: React.FC<AuthAIAssistantProps> = ({ onClose, context, initialPrompt }) => {
  ...
  const handleSend = async (promptToSend: string) => {
    ...
    try {
        ...
        logger.error('error', 'AuthAIAssistant — échec envoi', undefined, error as Error);
        setMessages(prev => [...prev, { role: 'ai', content: "Je rencontre un souci technique. Réessayez plus tard ou contactez votre administrateur." }]);
    } finally {
        setIsLoading(false);
    }
  };
