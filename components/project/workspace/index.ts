...
export { HistoryWorkspaceTab, type HistoryWorkspaceTabProps } from './HistoryWorkspaceTab';
export { TasksWorkspaceTab, type TasksWorkspaceTabProps } from './TasksWorkspaceTab';
