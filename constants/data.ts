...
export const mockProjects: Project[] = [
    {
        ...
        team: [],
        tasks: [
            { id: 't1', text: 'Finaliser le message clé et la proposition de valeur', status: 'Completed', priority: 'High', assignee: undefined, estimatedHours: 8, loggedHours: 6, dueDate: '2024-10-15' },
            { id: 't2', text: 'Calendrier éditorial réseaux sociaux', status: 'Completed', priority: 'High', assignee: undefined, estimatedHours: 12, loggedHours: 15, dueDate: '2024-10-20' },
            { id: 't3', text: 'Vidéos témoignages utilisateurs bêta', status: 'In Progress', priority: 'Medium', assignee: undefined, estimatedHours: 16, loggedHours: 4.5, dueDate: '2024-11-05' },
            { id: 't4', text: 'Webinaire de lancement', status: 'To Do', priority: 'High', estimatedHours: 40, loggedHours: 0, dueDate: '2024-12-01' },
        ],
        risks: []
    },
    {
    ...
    },
    {
        ...
        team: [],
        tasks: [
            { id: 't1-p3', text: 'Collecte FAQ', status: 'Completed', priority: 'High', estimatedHours: 10, loggedHours: 10 },
            { id: 't2-p3', text: 'Choix du service NLP', status: 'Completed', priority: 'High', estimatedHours: 20, loggedHours: 18 },
            { id: 't3-p3', text: 'Flux de conversation', status: 'Completed', priority: 'Medium', estimatedHours: 30, loggedHours: 35 },
            { id: 't4-p3', text: 'Intégration front-end', status: 'Completed', priority: 'Medium', estimatedHours: 25, loggedHours: 25 },
        ],
        risks: []
    }
];
