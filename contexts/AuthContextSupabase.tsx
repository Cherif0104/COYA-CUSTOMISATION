  ...
  if (!isSupabaseConfigured) {
    return (
      <div style={{ padding: 24, fontFamily: 'sans-serif', maxWidth: 720 }}>
        <h1 style={{ fontSize: 20, marginBottom: 8 }}>Configuration requise</h1>
        <p style={{ margin: 0, color: '#374151' }}>
          Supabase n’est pas configuré. Renseigne <b>VITE_SUPABASE_URL</b> et <b>VITE_SUPABASE_ANON_KEY</b> (dans{' '}
          <code>.env</code> / <code>.env.local</code>), puis redémarre le serveur.
        </p>
      </div>
    );
  }
