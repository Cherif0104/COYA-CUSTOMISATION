describe('Module Projets', () => {
  ...
  it('affiche la zone projets', () => {
    ...
    cy.contains('h2', /projets/i).should('be.visible');
  });
  ...
  it('ouvre le formulaire de création si le bouton est disponible', () => {
    cy.get('body').then(($body) => {
      ...
      cy.get('[data-testid="project-create-wizard"]', { timeout: 10000 }).should('be.visible');
      cy.get('[data-testid="project-create-title"]', { timeout: 10000 }).should('be.visible');
